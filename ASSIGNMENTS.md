...
| `WJetsLO` | 9 | large (1.83 B evts) | Arghya (arghyara) | **submitted** | **the analysis background** (W→lnu 4 + Wto2Q HT 5). Full round 2026-08-05, tasks `260805_2046`–`260805_2049`. Sweep 2026-08-09: **6/9 done + 100% published** (HT-100to400/800to1500/1500to2500/2500, WtoLNu-3J/4J — the `FileBased` override on 4J worked, 2723/2723); HT-400to800 running (51%), WtoLNu-2J running (81%); WtoLNu-1J 423/424 with 1 exit-8022 job resubmitted 2026-08-09. Auto-resubmit watchdog (2 h cycle, 3-resub cap) running on Purdue AF (Arghya) until all green; WtoLNu-1J terminal at **423/424** (job 126 frozen `rescheduled`, not manually resubmittable under Automatic splitting) → **recovery task `WtoLNu-4Jets_Bin-1J_HHBBTT_CHSUParT_recovery1` submitted 2026-08-12** (lumiMask = notFinishedLumis, 324 ranges; T1_US_FNAL blacklisted; publishes into the same dataset) |
| `QCD-4Jets_HT` | 11 | **largest group** | Arghya (arghyara) | **submitted** | **FULL round submitted 2026-08-12, 11/11 delivered** (publication ON, phys03); acceptance readback (RUNBOOK §3 criteria 2-3) in progress. Self-test 2026-08-09 passed 11/11 (1 file per bin on EOS). Blocks pre-screened twice via DBS `filesummaries`: max block-lumis 45,857 (HT-70to100) — safely under the 100k SUBMITREFUSED limit, no `FileBased` override needed. Test workareas archived to `testround_mcscouting_2024_QCD-4Jets_HT_*` |
