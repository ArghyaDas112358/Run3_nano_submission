...
cmsDriver.py $name --fileout file:$name.root --conditions $gt --filein $filein "${base_args[@]}" "${mc_args[@]}"
...
cmsDriver.py $name --fileout file:$name.root --conditions $gt --filein $filein "${base_args[@]}" "${data_args[@]}"
