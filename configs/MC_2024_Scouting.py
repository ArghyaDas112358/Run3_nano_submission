...
# with command line options: --python_file MC_2024_Scouting.py -s NANO:@GENFromMini+@ScoutFromMini --process NANO -n 10 --nThreads 4 --era Run3_2024 --customise PhysicsTools/NanoAOD/custom_run3scouting_cff.addScoutingPFCandidate --customise_commands process.NANOAODSIMoutput.outputCommands.append("keep edmTriggerResults_*_*_*") --no_exec --eventcontent NANOAODSIM --datatier NANOAODSIM --mc --fileout file:MC_2024_Scouting.root --conditions auto:phase1_2024_realistic --filein /store/mc/RunIII2024Summer24MiniAODv6/GluGluHHto2B2Tau_Par-c2-0p00-kl-0p00-kt-1p00_TuneCP5_13p6TeV_powheg-pythia8/MINIAODSIM/PowhegBugFix_150X_mcRun3_2024_realistic_v2-v2/2520000/02adb734-559d-4c0e-997d-984f4ef0f62e.root
...
from PhysicsTools.NanoAOD.custom_run3scouting_cff import addScoutingPFCandidate,customiseScoutingNano,customiseScoutingNanoFromMini 

#call to customisation function addScoutingPFCandidate imported from PhysicsTools.NanoAOD.custom_run3scouting_cff
